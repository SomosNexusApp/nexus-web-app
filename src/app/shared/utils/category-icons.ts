...
const ICON_MAP: Record<string, string> = {
  ...
  'juguetes': 'M17 9c.6 0 1.1-.1 1.5-.4c.8-.5 1.5-1.5 1.5-2.6c0-2-1.6-4-3.5-4c-1.5 0-2.8.9-3.3 2.2C12.4 4 11.2 3.5 10 3.5c-2.5 0-4.5 2-4.5 4.5c0 1.2.5 2.3 1.2 3.1C4.7 12.3 3 14.5 3 17a4 4 0 0 0 4 4h10a4 4 0 0 0 4-4c0-2.8-2.2-5.1-4.8-5.8c.5-.6.8-1.4.8-2.2z',
